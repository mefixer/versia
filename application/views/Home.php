...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container-fluid">
			<a class="navbar-brand" href="<?php echo base_url() ?>"><img src="./img/versia.icon.new.png" alt="" width="15%"></a>
		...
		<div class="container">
			<div class="container px-4">
				<div class="row gx-5">
					<div class="col">
						<div class="">
							<h1 class="display-2"><img src="./img/versia.icon.short.png" alt="" width="100%" height="auto"></h1>
...
<br>
			...
			<div class="row">
				<div class="jumbotron jumbotron-fluid">
					<div class="row">
						<div class="col-sm-3"><a class="nav-item" style="text-decoration: none;" href="https://api.whatsapp.com/send?phone=56949477660&text=Hola, quiero hacer una consulta."><img src="./img/whatsapp.png" alt="" width="24" height="auto"> +56949477660 </a></div>
						<div class="col-sm-3"><a class="nav-item" style="text-decoration: none;" href="mailto:hablemos@versia.cl"><img src="./img/correo.png" alt="" width="24" height="auto"> hablemos@versia.cl </a></div>
						<div class="col-sm-3"><a class="nav-item" style="text-decoration: none;" href="https://www.instagram.com/versiachile/"><img src="./img/insta.png" alt="" width="24" height="auto"> versiachile </a></div>
						<div class="col-sm-3"><a class="nav-item" style="text-decoration: none;" href="https://www.facebook.com/versiachile/"><img src="./img/face.png" alt="" width="24" height="auto"> versiachile </a></div>
					</div>
					<br>
					<br>
					<br>
